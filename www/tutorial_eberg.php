...
<p class="R_env">Running 2-fold cross validation...<br />
|==============================================================================================| 100%</p>
<p>In the third step, we can sum up the predictions using weighted averaging. <a href="merge-method.html">merge</a> function will by default use results of cross-validation to scale the prediction variances, which are then used as weigths:</p>
...
<ol>
  ...
  <li>Gotway, C.A.,  Young, L.J., (2007): <a href="http://dx.doi.org/10.1198/106186007X179257" target="_blank">A Geostatistical Approach to Linking Geographically
  Aggregated Data From Different Sources</a>. Journal of Computational and Graphical Statistics, <strong>16</strong> (1), 115-135</li>
